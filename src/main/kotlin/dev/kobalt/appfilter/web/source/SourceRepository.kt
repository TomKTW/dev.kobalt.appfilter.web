...
package dev.kobalt.appfilter.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.appfilter.android", "Application", "APK package of this application."),
        Triple("dev.kobalt.appfilter.web", "Frontend", "Website server that provides this page.")
    )
